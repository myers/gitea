...
// projectBoardMigration332 mirrors project_board table for migration
type projectBoardMigration332 struct {
	ID        int64 `xorm:"pk autoincr"`
	ProjectID int64 `xorm:"INDEX NOT NULL"`
	Sorting   int8  `xorm:"NOT NULL DEFAULT 0"`
}

func (projectBoardMigration332) TableName() string {
	return "project_board"
}

func (*projectBoardMigration332) TableIndices() []*schemas.Index {
...
type projectIssueMigration332 struct {
	ID              int64 `xorm:"pk autoincr"`
...
func (projectIssueMigration332) TableName() string {
	return "project_issue"
}

func (*projectIssueMigration332) TableIndices() []*schemas.Index {
...
func FixProjectSortingAndAddUniqueConstraints(x *xorm.Engine) error {
	...
	if err := x.Sync(new(projectBoardMigration332)); err != nil {
		return err
	}
	return x.Sync(new(projectIssueMigration332))
}
