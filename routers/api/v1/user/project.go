...
func getUserProjectByID(ctx *context.APIContext) *project_model.Project {
	p, err := project_model.GetProjectByIDAndOwner(ctx, ctx.PathParamInt64("project_id"), ctx.Doer.ID)
	if err != nil {
...
func getUserProjectColumn(ctx *context.APIContext, project *project_model.Project) *project_model.Column {
...
func ListProjects(ctx *context.APIContext) {
	// swagger:operation GET /user/projects project userListProjects
	// ---
...
func CreateProject(ctx *context.APIContext) {
	...
	project, err := project_service.CreateProject(ctx, ctx.Doer.ID, 0, project_model.TypeIndividual, ctx.Doer, project_service.CreateProjectOptions{
		Title:        form.Title,
...
// GetProject get a user's project
func GetProject(ctx *context.APIContext) {
	// swagger:operation GET /user/projects/{project_id} project userGetProject
	// ---
...
// EditProject edit a user's project
func EditProject(ctx *context.APIContext) {
	// swagger:operation PATCH /user/projects/{project_id} project userEditProject
	// ---
	...
	project, err := project_model.GetProjectByIDAndOwner(ctx, project.ID, ctx.Doer.ID)
	if err != nil {
		ctx.APIErrorInternal(err)
		return
	}
...
// DeleteProject delete a user's project
func DeleteProject(ctx *context.APIContext) {
	// swagger:operation DELETE /user/projects/{project_id} project userDeleteProject
	// ---
...
func ListProjectColumns(ctx *context.APIContext) {
	// swagger:operation GET /user/projects/{project_id}/columns project userListProjectColumns
	// ---
...
func CreateProjectColumn(ctx *context.APIContext) {
	// swagger:operation POST /user/projects/{project_id}/columns project userCreateProjectColumn
	// ---
...
func GetProjectColumn(ctx *context.APIContext) {
	// swagger:operation GET /user/projects/{project_id}/columns/{column_id} project userGetProjectColumn
	// ---
	...
	col := getUserProjectColumn(ctx, project)
	if ctx.Written() {
		return
	}
...
func EditProjectColumn(ctx *context.APIContext) {
	// swagger:operation PATCH /user/projects/{project_id}/columns/{column_id} project userEditProjectColumn
	// ---
...
func DeleteProjectColumn(ctx *context.APIContext) {
	// swagger:operation DELETE /user/projects/{project_id}/columns/{column_id} project userDeleteProjectColumn
	// ---
...
func MoveProjectColumn(ctx *context.APIContext) {
	// swagger:operation POST /user/projects/{project_id}/columns/{column_id}/move project userMoveProjectColumn
	// ---
...
func ListProjectCards(ctx *context.APIContext) {
	// swagger:operation GET /user/projects/{project_id}/columns/{column_id}/cards project userListProjectCards
	// ---
...
func AddProjectCard(ctx *context.APIContext) {
	// swagger:operation POST /user/projects/{project_id}/columns/{column_id}/cards project userAddProjectCard
	// ---
...
func DeleteProjectCard(ctx *context.APIContext) {
	// swagger:operation DELETE /user/projects/{project_id}/columns/{column_id}/cards/{card_id} project userDeleteProjectCard
	// ---
	...
	_ = getUserProjectColumn(ctx, project)
	if ctx.Written() {
		return
	}
...
func MoveProjectCard(ctx *context.APIContext) {
	// swagger:operation POST /user/projects/{project_id}/columns/{column_id}/cards/{card_id}/move project userMoveProjectCard
	// ---
