...
func getRepoProjectByID(ctx *context.APIContext) *project_model.Project {
	p, err := project_model.GetProjectForRepoByID(ctx, ctx.Repo.Repository.ID, ctx.PathParamInt64("project_id"))
	if err != nil {
...
func getProjectColumn(ctx *context.APIContext, project *project_model.Project) *project_model.Column {
...
func CreateProject(ctx *context.APIContext) {
	...
	project, err := project_service.CreateProject(ctx, 0, ctx.Repo.Repository.ID, project_model.TypeRepository, ctx.Doer, project_service.CreateProjectOptions{
		Title:        form.Title,
...
func GetProject(ctx *context.APIContext) {
	// swagger:operation GET /repos/{owner}/{repo}/projects/{project_id} project projectGetProject
	// ---
...
func EditProject(ctx *context.APIContext) {
	// swagger:operation PATCH /repos/{owner}/{repo}/projects/{project_id} project projectEditProject
	// ---
	...
	project, err := project_model.GetProjectForRepoByID(ctx, ctx.Repo.Repository.ID, project.ID)
	if err != nil {
		ctx.APIErrorInternal(err)
		return
	}
...
func DeleteProject(ctx *context.APIContext) {
	// swagger:operation DELETE /repos/{owner}/{repo}/projects/{project_id} project projectDeleteProject
	// ---
...
func ListProjectColumns(ctx *context.APIContext) {
	// swagger:operation GET /repos/{owner}/{repo}/projects/{project_id}/columns project projectListColumns
	// ---
...
func CreateProjectColumn(ctx *context.APIContext) {
	// swagger:operation POST /repos/{owner}/{repo}/projects/{project_id}/columns project projectCreateColumn
	// ---
...
func GetProjectColumn(ctx *context.APIContext) {
	// swagger:operation GET /repos/{owner}/{repo}/projects/{project_id}/columns/{column_id} project projectGetColumn
	// ---
	...
	col := getProjectColumn(ctx, project)
	if ctx.Written() {
		return
	}
...
func EditProjectColumn(ctx *context.APIContext) {
	// swagger:operation PATCH /repos/{owner}/{repo}/projects/{project_id}/columns/{column_id} project projectEditColumn
	// ---
...
func DeleteProjectColumn(ctx *context.APIContext) {
	// swagger:operation DELETE /repos/{owner}/{repo}/projects/{project_id}/columns/{column_id} project projectDeleteColumn
	// ---
...
func MoveProjectColumn(ctx *context.APIContext) {
	// swagger:operation POST /repos/{owner}/{repo}/projects/{project_id}/columns/{column_id}/move project projectMoveColumn
	// ---
...
func ListProjectCards(ctx *context.APIContext) {
	// swagger:operation GET /repos/{owner}/{repo}/projects/{project_id}/columns/{column_id}/cards project projectListCards
	// ---
...
func AddProjectCard(ctx *context.APIContext) {
	// swagger:operation POST /repos/{owner}/{repo}/projects/{project_id}/columns/{column_id}/cards project projectAddCard
	// ---
...
func DeleteProjectCard(ctx *context.APIContext) {
	// swagger:operation DELETE /repos/{owner}/{repo}/projects/{project_id}/columns/{column_id}/cards/{card_id} project projectDeleteCard
	// ---
	...
	_ = getProjectColumn(ctx, project)
	if ctx.Written() {
		return
	}
...
func MoveProjectCard(ctx *context.APIContext) {
	// swagger:operation POST /repos/{owner}/{repo}/projects/{project_id}/columns/{column_id}/cards/{card_id}/move project projectMoveCard
	// ---
	...
	// Verify source column belongs to project
	_ = getProjectColumn(ctx, project)
	if ctx.Written() {
		return
	}
